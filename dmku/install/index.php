...
<nav class="navbar navbar-fixed-top navbar-default">
    <div class="container">
      <div class="navbar-header">
        <span class="navbar-brand">弹幕库安装向导</span>
      </div><!-- /.navbar-header -->
    </div><!-- /.container -->
  </nav><!-- /.navbar -->
...
<div class="panel panel-primary">
	<div class="panel-heading" style="background: #15A638;">
		<h3 class="panel-title" align="center">欢迎使用哔哩哔哩播放器</h3>
	</div>
	<div class="panel-body">
		<p><iframe src="../readme.txt" style="width:100%;height:465px;"></iframe></p>
		<?php if($installed){ ?>
		<div class="alert alert-warning">您已经安装过，如需重新安装请删除<font color=red> dmku/install/install.lock </font>文件后再安装！</div>
		<?php }else{?>
...
<div class="progress progress-striped">
  <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 30%">
	...
	<div class="panel-body">
		...
		（如果已事先填写好 /dmku/config.php相关数据库配置，请 <a href="?do=3&jump=1">点击此处</a> 跳过这一步！）
	</div>
</div>
...
if($_GET['jump']==1){
	...
	if(!$dbconfig['user']||!$dbconfig['pwd']||!$dbconfig['dbname']) {
		...
		if(!$con=DB::connect($dbconfig['host'],$dbconfig['user'],$dbconfig['pwd'],$dbconfig['dbname'],$dbconfig['port'])){
			...
			if(DB::query('SELECT * FROM danmaku_config WHERE 1')==FALSE)
				echo '<p align="right"><a class="btn btn-primary btn-block" href="?do=4">创建数据表>></a></p>';
			else
				echo '<div class="list-group-item list-group-item-info">系统检测到你已安装过哔哩哔哩播放器弹幕</div>
...
<?php
	...
	echo '<div class="alert alert-info"><font color="green">安装完成！</font><br/><br/><a href="../../">>>网站首页</a><hr/><font color="blue">提示：要想解析更多视频，需要配置解析json，说明请到源码根目录config.php查看。</font><br/>更多设置选项请登录后台管理进行修改。<br/><br/><font color="#FF0033">如果你的空间不支持本地文件读写，请自行在install/ 目录建立 install.lock 文件！</font></div>';
?>
	</div>
</div>
